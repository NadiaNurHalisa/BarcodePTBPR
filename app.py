...
st.markdown("<div class='header-subtitle'>NASKAH DINAS INI DIKELOLA OLEH</div>", unsafe_allow_html=True)
st.markdown("<div class='header-title'>PT BANK PEREKONOMIAN RAKYAT<br>BANK DAERAH PATI</div>", unsafe_allow_html=True)
st.markdown("<hr class='rule'>", unsafe_allow_html=True)
if halaman == "disahkan":
    st.markdown("<div class='verified-panel'>✔ NASKAH INI TELAH DISAHKAN DAN TERVERIFIKASI</div>", unsafe_allow_html=True)
st.markdown("<span class='badge-status'>✔ RESMI &amp; TERVERIFIKASI</span>", unsafe_allow_html=True)
st.markdown("<p class='intro'><b>Naskah ini telah ditandatangani secara sah oleh :</b></p>", unsafe_allow_html=True)
st.markdown(
    f"""
...
st.markdown("<div class='footer'>© 2026 PT BPR Bank Daerah Pati</div>", unsafe_allow_html=True)